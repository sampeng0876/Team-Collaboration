...
class PDFCapture:
    ...
    def capture_data(self):
        data = []
        x_positions = [
            (75, 121), (273, 334), (22, 263), (103, 291), (337, 362), (459, 517), (273, 427), (437, 491), (25, 221)
        ]
        y_positions = [
            (126, 135), (339, 392), (280, 346), (18, 37), (340, 392), (511, 523), (412, 469), (230, 240), (219, 261)
        ]
...
def scan_and_process_files():
    pdf_paths = []
    directory = r'/Users/champagne/Library/CloudStorage/GoogleDrive-sp.dispatchservice@gmail.com/My Drive/Company/FaCai/DO/QZ'
